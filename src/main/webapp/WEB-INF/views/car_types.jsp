...
<html>
                          ...
                          <c:forEach items="${car_types}" var="type">
                           <li>
                             <div class="collapsible-header" typeId="${type.id}">
                               <div class="inline">${type.typeName}</div>
                               <a href="<%=UrlConstant.DELETE_CAR_TYPE%>?<%=ParamAttrConstant.TYPE_ID%>=${type.id}" class="right"><i class="material-icons center icon-red waves-orange">delete</i></a>
                               <a class="right"><i class="waves-effect waves-light small material-icons center icon-orange">edit</i></a>
                             </div>
                             <div class="collapsible-body">
                               <div class="content-collapsible-body">
                                 <div>
                                   <div class="inline">Booking price</div>
                                   <div class="right">${type.priceBooking} $</div>
                                 </div>
                                 <div>
                                   <div class="inline">Per Km price</div>
                                   <div class="right">${type.pricePerKm} $</div>
                                 </div>
                                 <div>
                                   <div class="inline">Capacity</div>
                                   <div class="right">${type.capacity}</div>
                                 </div>
                             </div>
                             </div>
                           </li>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.7/js/materialize.min.js"></script>
    ...
    <script type="text/javascript" src="../../static/js/cars.js"></script>
