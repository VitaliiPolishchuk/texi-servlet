...
<html class="carousel-page">
    ...
    <body>
                      ...
                      <div class="card white darken-1">
                        <div id="parent" class="card-content black-text">
                          ...
                          <div class="card-action">
                            <a class="waves-effect waves-light btn" href="<%=UrlConstant.PROCESS_ORDER%>?<%=ParamAttrConstant.CAR_ID%>=${order.car.id}"><fmt:message key="car_type_choose.choose"/></a>
                          </div>
        ...
        <script type="text/javascript" src="../../static/js/car-type-choose.js"></script>
    </body>
</html>