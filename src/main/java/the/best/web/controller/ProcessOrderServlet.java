...
public class ProcessOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        desirableOrder.setOrigin(new Location((String)session.getAttribute(ParamAttrConstant.DESTINATION)));
        orderDAO.save(orderService.getCarById(orders, car_id), (User)session.getAttribute(ParamAttrConstant.USER));
